        ...
        <div className="bg-white dark:bg-primary-gray p-8 rounded-lg shadow-xl">
            ...
            {submitSuccess ? (
                <motion.div 
                    ...
                    className="flex flex-col items-center justify-center py-16 px-8 bg-success-emerald/5 border border-success-emerald/20 rounded-3xl text-center backdrop-blur-sm"
                >
                    <div className="w-24 h-24 bg-success-emerald/10 rounded-full flex items-center justify-center mb-8 relative">
                        <div className="absolute inset-0 bg-success-emerald/20 rounded-full animate-ping opacity-20"></div>
                        <CheckCircle className="w-12 h-12 text-success-emerald relative z-10" />
                    </div>
                    <h4 className="text-3xl font-display font-bold text-white mb-4 tracking-tighter">Message <span className="text-success-emerald">Delivered</span></h4>
                    <p className="text-white/40 font-light max-w-sm mx-auto leading-relaxed mb-10">
                        Our intelligence desk has received your transmission. A specialized agent will analyze your inquiry and formulate a response within one business cycle.
                    </p>
                    <div className="h-px w-20 bg-white/10 mb-10 mx-auto"></div>
                    <button 
                        onClick={() => setSubmitSuccess(false)}
                        className="text-electric-blue font-mono font-bold uppercase tracking-[0.3em] text-[10px] hover:text-white transition-colors duration-300 flex items-center gap-2"
                    >
                        New Transmission <Send size={12} />
                    </button>
                </motion.div>
            ) : (
                <form onSubmit={handleSubmit} noValidate className="space-y-6">
                    ...
                    <button
                        ...
                        className="w-full bg-primary-red text-white font-bold px-8 py-3 rounded-lg text-lg hover:bg-red-700 disabled:bg-gray-500 disabled:cursor-not-allowed transition duration-300 transform hover:scale-105 flex items-center justify-center gap-2"
                    >
                        {isSubmitting ? (
                            <>
      ...
      <div className="container mx-auto px-4 sm:px-6 -mt-16 relative z-20">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-16">
            ...
            <ContactInfoCard 
                ...
                title="Email Us"
                details={['support@manifestpay.online', 'info@manifestpay.online', 'careers@manifestpay.online']}
            />
            <ContactInfoCard 
                delay={300}
